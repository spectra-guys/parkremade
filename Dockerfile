...
ENTRYPOINT []
CMD ffmpeg
-stream_loop -1 -i "https://github.com/spectra-guys/parkremade/blob/master/video.mp4" -deinterlace \
 -vcodec libx264 -pix_fmt yuv420p -preset medium -r 30 -g $(($FPS * 2)) -b:v 2500k \
