...
ENTRYPOINT []
CMD ffmpeg -re -f lavfi -i smptebars=size=640x320:rate=15 -f flv -vcodec libx264 -pix_fmt yuv420p -preset fast -r 15 -g 30 rtmp://a.rtmp.youtube.com/live2/$TWITCH_STREAMKEY