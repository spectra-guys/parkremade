...
ENTRYPOINT []
CMD ffmpeg -re -f lavfi -i https://github.com/spectra-guys/parkremade/blob/master/video.mp4 -f flv -vcodec libx264 -pix_fmt yuv420p -preset fast -r 15 -g 30 rtmp://bangalore.restream.io/live/$TWITCH_STREAMKEY